...
#' indicates is in nM units) is converted to a log_dose column in log10(molar),
#' and a "response" column is generated by subtracting the percent inhibition
#' from 100.
...
#'   * % Inhibition 1
#'   * % Inhibition 2
#' @return The processed table as a tibble.
#' @export
#'
import_selectscreen <- function(input_filename){
  ...
  raw_data |>
    dplyr::mutate(target = forcats::fct_inorder(target)) |>
